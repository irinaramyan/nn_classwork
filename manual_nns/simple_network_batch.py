...
def fit_batch(x, y, w1, w2, b1, b2, lr, epochs, batch_size):
    ...
    for epoch in range(epochs):
        ...
        for start in range(0, x.shape[0], batch_size):
            ...
            grad_w1, grad_b1, grad_w2, grad_b2 = backward_pass(x_batch, y_batch, z1, a1, z2, a2, w1, w2, b1, b2)
...
w1_saver, b1_saver, w2_saver, b2_saver, loss_saver = fit_batch(x, y, w1, w2, b1, b2, 0.01, 1000, 64)

plt.plot(loss_saver, color='crimson')
plt.show()